...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_binius_sha256_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_binius_sha256_rustbuffer_free(self, $0) }
    }
}
...
private func makeRustCall<T, E: Swift.Error>(
    ...
    uniffiEnsureBiniusSha256Initialized()
...
public struct BiniusSha256Result {
    public var prepareTime: String
    public var proveTime: String
    public var verifyTime: String

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(prepareTime: String, proveTime: String, verifyTime: String) {
...
#if compiler(>=6)
extension BiniusSha256Result: Sendable {}
#endif


extension BiniusSha256Result: Equatable, Hashable {
    public static func ==(lhs: BiniusSha256Result, rhs: BiniusSha256Result) -> Bool {
        if lhs.prepareTime != rhs.prepareTime {
            return false
        }
        if lhs.proveTime != rhs.proveTime {
            return false
        }
        if lhs.verifyTime != rhs.verifyTime {
            return false
        }
        return true
    }
    ...
    public func hash(into hasher: inout Hasher) {
        hasher.combine(prepareTime)
        hasher.combine(proveTime)
        hasher.combine(verifyTime)
    }
}
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeBiniusSha256Result: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> BiniusSha256Result {
        return
            try BiniusSha256Result(
                prepareTime: FfiConverterString.read(from: &buf), 
                proveTime: FfiConverterString.read(from: &buf), 
                verifyTime: FfiConverterString.read(from: &buf)
        )
    }

    public static func write(_ value: BiniusSha256Result, into buf: inout [UInt8]) {
        FfiConverterString.write(value.prepareTime, into: &buf)
        FfiConverterString.write(value.proveTime, into: &buf)
        FfiConverterString.write(value.verifyTime, into: &buf)
    }
}
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeBiniusSha256Result_lift(_ buf: RustBuffer) throws -> BiniusSha256Result {
    return try FfiConverterTypeBiniusSha256Result.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeBiniusSha256Result_lower(_ value: BiniusSha256Result) -> RustBuffer {
    return FfiConverterTypeBiniusSha256Result.lower(value)
}
...
public func biniusSha256() -> BiniusSha256Result  {
    return try!  FfiConverterTypeBiniusSha256Result_lift(try! rustCall() {
    uniffi_binius_sha256_fn_func_binius_sha256($0
    )
})
}
public func generateCircomProof(zkeyPath: String, circuitInputs: String, proofLib: ProofLib)throws  -> CircomProofResult  {
    ...
    uniffi_binius_sha256_fn_func_generate_circom_proof(
...
public func generateHalo2Proof(srsPath: String, pkPath: String, circuitInputs: [String: [String]])throws  -> Halo2ProofResult  {
    ...
    uniffi_binius_sha256_fn_func_generate_halo2_proof(
...
public func generateNoirProof(circuitPath: String, srsPath: String?, inputs: [String])throws  -> Data  {
    ...
    uniffi_binius_sha256_fn_func_generate_noir_proof(
...
public func verifyCircomProof(zkeyPath: String, proofResult: CircomProofResult, proofLib: ProofLib)throws  -> Bool  {
    ...
    uniffi_binius_sha256_fn_func_verify_circom_proof(
        FfiConverterString.lower(zkeyPath),
...
public func verifyHalo2Proof(srsPath: String, vkPath: String, proof: Data, publicInput: Data)throws  -> Bool  {
    return try  FfiConverterBool.lift(try rustCallWithError(FfiConverterTypeMoproError_lift) {
    uniffi_binius_sha256_fn_func_verify_halo2_proof(
        FfiConverterString.lower(srsPath),
...
public func verifyNoirProof(circuitPath: String, proof: Data)throws  -> Bool  {
    return try  FfiConverterBool.lift(try rustCallWithError(FfiConverterTypeMoproError_lift) {
    uniffi_binius_sha256_fn_func_verify_noir_proof(
        FfiConverterString.lower(circuitPath),
...
private let initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_binius_sha256_uniffi_contract_version()
    if bindings_contract_version != scaffolding_contract_version {
        return InitializationResult.contractVersionMismatch
    }
    if (uniffi_binius_sha256_checksum_func_binius_sha256() != 42095) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_binius_sha256_checksum_func_generate_circom_proof() != 48451) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_binius_sha256_checksum_func_generate_halo2_proof() != 41055) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_binius_sha256_checksum_func_generate_noir_proof() != 26525) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_binius_sha256_checksum_func_verify_circom_proof() != 37341) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_binius_sha256_checksum_func_verify_halo2_proof() != 14120) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_binius_sha256_checksum_func_verify_noir_proof() != 54556) {
        return InitializationResult.apiChecksumMismatch
    }
...
public func uniffiEnsureBiniusSha256Initialized() {
